...
Example used in the [tsflex paper](https://www.sciencedirect.com/science/article/pii/S2352711021001904). The example elaborates shows how tsflex can be applied for processing & feature extraction on multivariate (and even irregularly sampled) time series data.
